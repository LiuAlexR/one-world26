...
export default function App() {
  ...
  // Map fade in
  const mapOpacity = scrollProgress < 0.3 ? 0 : Math.min(1, (scrollProgress - 0.3) * 3.3);
    ...
    <div style={{ color: "white", minHeight: "300vh", width: "100%" }}>
      ...
      <div
        style={{
          ...
          pointerEvents: scrollProgress > 0.3 && !isMapFinished ? "auto" : "none",
        }}
      >
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            borderRadius: "4px",
            opacity: isMapFinished ? 1 : 0,
            pointerEvents: isMapFinished ? "auto" : "none",
